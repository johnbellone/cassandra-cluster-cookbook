...
default['cassandra-cluster']['service']['remote_url'] = "http://apache.cs.utah.edu/cassandra/%(version)/apache-cassandra-%(version)-bin.tar.gz" # rubocop:disable Style/StringLiterals
